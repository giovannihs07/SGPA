...
var AvatarGroup = React7.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsxs)(AvatarGroupRoot, _extends({
    ...
    children: [extraAvatars ? (0, import_jsx_runtime8.jsx)(Avatar_default, _extends({
      variant
...
var ButtonGroup = React8.forwardRef(function ButtonGroup2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiButtonGroup"
  });
  ...
  return (0, import_jsx_runtime10.jsx)(ButtonGroupRoot, _extends({
    as: component,
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
...
var PaginationItem = React11.forwardRef(function PaginationItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaginationItem"
  });
...
var Pagination = React12.forwardRef(function Pagination2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPagination"
  });
...
var Zoom = React13.forwardRef(function Zoom2(props, ref) {
...
var Fab = React14.forwardRef(function Fab2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFab"
  });
  ...
  return (0, import_jsx_runtime17.jsx)(FabRoot, _extends({
    className: clsx_default(classes.root, className),
    component,
    disabled,
...
var SpeedDial = React15.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsxs)(SpeedDialRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    ...
    children: [(0, import_jsx_runtime18.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime18.jsx)(SpeedDialFab, _extends({
        color: "primary",
...
var SpeedDialActionFab = styled_default(Fab_default, {
  ...
  "&:hover": {
    backgroundColor: theme.vars ? theme.vars.palette.SpeedDialAction.fabHoverBg : (0, import_colorManipulator4.emphasize)(theme.palette.background.paper, 0.15)
  },
...
var SpeedDialAction = React16.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const fab = (0, import_jsx_runtime20.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime21.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
  ...
  return (0, import_jsx_runtime20.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
var SpeedDialIcon = React18.forwardRef(function SpeedDialIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime24.jsxs)(SpeedDialIconRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    ownerState
  }, other, {
...
var TabScrollButton = React19.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime25.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime25.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React20.useRef();
  ...
  return (0, import_jsx_runtime26.jsx)("div", _extends({
    style: styles2,
    ref: nodeRef
  }, other));
}
...
var Tabs = React21.forwardRef(function Tabs2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React21.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React21.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React21.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React21.useState(false);
  const [scrollerStyle, setScrollerStyle] = React21.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React21.useRef(null);
  const tabListRef = React21.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React21.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime27.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime27.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime27.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
    className: clsx_default(classes.indicator, TabIndicatorProps.className),
    ownerState,
    style: _extends({}, indicatorStyle, TabIndicatorProps.style)
  }));
  let childIndex = 0;
  const children = React21.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React21.cloneElement(child, _extends({
  ...
  return (0, import_jsx_runtime28.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime28.jsxs)(TabsScroller, {
...
var _excluded23 = ["children", "className", "color", "disabled", "disableFocusRipple", "fullWidth", "onChange", "onClick", "selected", "size", "value"];
...
var ToggleButton = React24.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React24.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  ...
  return (0, import_jsx_runtime29.jsx)(ToggleButtonRoot, _extends({
...
var ToggleButtonGroup = React25.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime30.jsx)(ToggleButtonGroupRoot, _extends({
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
    ownerState
    ...
    children: (0, import_jsx_runtime30.jsx)(ToggleButtonGroupContext_default.Provider, {
      ...
      children: validChildren.map((child, index) => {
        ...
        return (0, import_jsx_runtime30.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
          value: getButtonPositionClassName(index),
          children: child
        }, index);
      })
...
true ? ToggleButtonGroup.propTypes = {
   ...
   * @default false
   */
  exclusive: import_prop_types16.default.bool,
  /**
...
//# sourceMappingURL=chunk-4IXQBVLW.js.map
