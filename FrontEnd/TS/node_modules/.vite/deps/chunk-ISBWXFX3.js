...
var maybeReactUseSyncExternalStore = React7["useSyncExternalStore"];
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => {
    const value = React15.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React15.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsxs)(React15.Fragment, {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React17.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React17.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React17.useContext(GridOverflowContext);
    const {
      className,
      children,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ISBWXFX3.js.map
